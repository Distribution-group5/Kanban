...
export class BoardComponent implements OnInit {
  ...
  kanbanBoard = new KanbanBoard(1, "Example", [
    [new KanbanCard(1, "Card1 title", "This is the content1", ["Bob", "Berta"], new Date(Date.now()), new Date(Date.now())), new KanbanCard(3, "Card3 title", "This is the content3", ["Kurt", "Troels"], new Date(Date.now()), new Date(Date.now())), new KanbanCard(6, "Card6 title", "This is the content6", ["Kurt", "Troels"], new Date(Date.now()), new Date(Date.now())),new KanbanCard(7, "Card7 title", "This is the content7", ["Kurt", "Troels"], new Date(Date.now()), new Date(Date.now())), new KanbanCard(8, "Card8 title", "This is the content8", ["Kurt", "Troels"], new Date(Date.now()), new Date(Date.now())), new KanbanCard(12, "Card12 title", "This is the content12", ["Kurt", "Troels"], new Date(Date.now()), new Date(Date.now()))], 
